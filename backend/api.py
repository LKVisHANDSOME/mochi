...
class problem(Resource):
    ...
    def post(self):
        ...
        new_problem = Problem(questioner_id=problem.questioner_id,problem_name=problem.name,difficulty=problem.difficulty,topic=problem.topic,problem_content=problem.content,time_limit=problem.time_limit,memory_limit=problem.memory_limit,is_hidden=problem.is_hidden)
        from app import db
